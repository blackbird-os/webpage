...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			parallaxBackgroundImage: 'media/bg.png', // CSS syntax, e.g. "a.jpg"

			// Parallax background size
			parallaxBackgroundSize: '2560px 1440px', // CSS syntax, e.g. "3000px 2000px"

			// Parallax background repeat
			parallaxBackgroundRepeat: 'no-repeat', // repeat/repeat-x/repeat-y/no-repeat/initial/inherit
